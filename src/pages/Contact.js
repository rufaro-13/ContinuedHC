...
//}
  return (
    <div>
        ...
        <center>
        <div class="max-w-fit sm:82 rounded-lg  items-center sm:items-center sm:justify-center   mx-8 mt-1">

            <div class="max-w-fit  sm:82 rounded-lg   sm:items-center sm:justify-center py-4  ml-48 mt-8">
